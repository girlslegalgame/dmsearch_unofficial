...
/** 画像URL取得 (index.php, get_card_details.php共通) */
...
function get_civ_priority($card) {
    ...
    if ($civ_count > 1) return 7; // 多色
    if ($min_id == 6) return 0;  // 無色
    if ($min_id >= 1 && $min_id <= 5) return $min_id; // 各文明
    return 99;
}
